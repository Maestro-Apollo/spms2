                                ...
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control mb-3" placeholder="Code" id="code" name="code" value="<?php echo $row['code']; ?>" readonly required>
                                            <div id="outputC"></div>
                                        </div>
                                        <div class="col-6">
                                            <label for="">District</label>

                                            <input type="text" value="<?php echo $row['district']; ?>" class="form-control mb-3" placeholder="District" name="district">
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="building" class="form-control mb-3" placeholder="Building name" name="building" value="<?php echo $row['building']; ?>" required>
                                        <div id="outputB" class=""></div>
                                    </div>
                                    <div>
                                        <label for="">Address</label>

                                        <input type="text" value="<?php echo $row['street']; ?>" id="address" class="form-control mb-3" placeholder="Address" name="street">
                                        <div id="outputA" class=""></div>
                                    </div>
                                    <div>
                                        <label for="">Year</label>

                                        <input type="text" value="<?php echo $row['year']; ?>" id="year" class="form-control mb-3" placeholder="Year" name="year">
                                        <div id="outputA" class=""></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" value="<?php echo $row['block']; ?>" class="form-control mb-3" placeholder="Block" name="block" autocomplete="on">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Floor</label>

                                            <input type="text" value="<?php echo $row['floor']; ?>" class="form-control mb-3" placeholder="Floor" name="floor" autocomplete="on">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" value="<?php echo $row['flat']; ?>" class="form-control mb-3" placeholder="Flat" name="flat" autocomplete="on">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Room Number</label>

                                            <input type="number" value="<?php echo $row['no_room']; ?>" class="form-control mb-3" placeholder="No of Rooms" name="no_rooms" id="no_rooms" required>
                                        </div>
                                    </div>
                                    <div class="mt-2">
                                        <p class="mb-0">Room Display By</p>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline1" <?php echo ($row['display_by'] == 'alp') ? 'checked' : ''; ?> name="display" class="custom-control-input" value="alp">
                                            <label class="custom-control-label" for="customRadioInline1">A,B,C,D...</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline2" <?php echo ($row['display_by'] == 'num') ? 'checked' : ''; ?> name="display" class="custom-control-input" value="num">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" value="<?php echo $row['cargo_lift']; ?>" class="form-control mb-3" placeholder="Cargo Lift" name="cargo_lift">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Customer Lift</label>

                                            <input type="text" value="<?php echo $row['customer_lift']; ?>" class="form-control mb-3" placeholder="Customer Lift" name="customer_lift">
                                        </div>
                                        <div class="col-6">
                                            <label for="" class="mb-3 text-center d-block">24 hour</label>
                                            <select id="" name="tf_hr" class="form-control">

                                                <option value="Yes" <?php echo ($row['tf_hr'] == 'Yes') ? 'selected' : ''; ?>>Yes
                                                </option>
                                                <option value="No" <?php echo ($row['tf_hr'] == 'No') ? 'selected' : ''; ?>>No</option>
                                            </select>

                                        </div>
                                        <div class="col-6 mt-4">
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" name="individual" value="Yes" <?php echo ($row['individual'] == 'Yes') ? 'checked' : ''; ?> id="exampleCheck1">
                                                <label class="form-check-label" for="exampleCheck1">Individual</label>
                                            </div>
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input" name="separate" <?php echo ($row['separate'] == 'Yes') ? 'checked' : ''; ?> value="Yes" id="exampleCheck2">
                                        ...
                                        <div class="col-12 mt-2">
                                            ...
                                            <input type="text" value="<?php echo $row['enter_password']; ?>" class="form-control mb-3" placeholder="Entry Password" name="entry_password">
                                        </div>


                                        <div class="col-12 mt-2">
                                            <textarea name="admin_comment" class="form-control" id="" cols="30" rows="3" placeholder="Admin Comment" <?php echo (isset($_SESSION['name2']) ? 'readonly' : '') ?>><?php echo $rowComment['admin_comment']; ?></textarea>
                                        </div>


                                        <div class="col-12 mt-2">
                                            <textarea name="agent_comment" class="form-control" id="" cols="30" rows="3" placeholder="Agent Comment" <?php echo (isset($_SESSION['admin2']) ? 'readonly' : '') ?>><?php echo $rowComment['agent_comment']; ?></textarea>
                                        </div>
                                ...
                                <div id="step-4" class="tab-pane" role="tabpanel" aria-labelledby="step-4">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control mb-3" value="<?php echo $rowLand['contact1'] ?>" placeholder="Contact 1" name="contact1">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Number 1</label>

                                            <input type="text" value="<?php echo $rowLand['number1'] ?>" class="form-control mb-3" placeholder="Number 1" name="number1">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" value="<?php echo $rowLand['contact2'] ?>" class="form-control mb-3" placeholder="Contact 2" name="contact2">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Number 2</label>

                                            <input type="text" value="<?php echo $rowLand['number2'] ?>" class="form-control mb-3" placeholder="Number 2" name="number2">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" value="<?php echo $rowLand['contact3'] ?>" class="form-control mb-3" placeholder="Contact 3" name="contact3">
                                        </div>
                                        <div class="col-6">
                                            <label for="">Number 3</label>

                                            <input type="text" value="<?php echo $rowLand['number3'] ?>" class="form-control mb-3" placeholder="Number 3" name="number3">
                                        </div>
                                    </div>
                                    <label for="">Landlord Name</label>

                                    <input type="text" value="<?php echo $rowLand['landlord_name'] ?>" class="form-control mb-3" placeholder="Landlord Name" name="landlord_name">
                                    <label for="">Bank</label>

                                    <input type="text" value="<?php echo $rowLand['bank'] ?>" class="form-control mb-3" placeholder="Bank" name="bank">
                                    <label for="">Bank Account</label>

                                    <input type="text" value="<?php echo $rowLand['bank_acc'] ?>" class="form-control mb-3" placeholder="Bank account" name="bank_account">
                                    <label for="">Remark</label>

                                    <textarea name="remark" class="form-control mb-3" placeholder="Remark" id="" cols="30" rows="5"><?php echo $rowLand['remarks'] ?></textarea>
                                    <button type="submit" name="submit" class="btn btn-block font-weight-bold log_btn btn-lg mt-4">UPDATE</button>
                                </div>
