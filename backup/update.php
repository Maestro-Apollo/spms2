    ...
    public function signInFunction()
    {
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($resF) > 0) {
                $sqlComment = "UPDATE comment SET person_name = '$AgentName', admin_comment = '$admin_comment' , agent_comment = '$agent_comment', `date` = CURRENT_TIMESTAMP where code = '$code'  ";
            ...
            $sql4 = "UPDATE `landlord_details` SET `landlord_name`='$landlord_name',`bank`='$bank',`bank_acc`='$bank_account',`remarks`='$remakeLand',`landlord_created_at`=CURRENT_TIMESTAMP,`contact1`='$contact1',`number1`='$number1',`contact2`='$contact2',`number2`='$number2',`contact3`='$contact3',`number3`='$number3' WHERE code = '$code' ";
